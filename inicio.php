				...
				<div class="container py-xl-5 py-lg-3">
					<div class="row py-xl-4">
						<div class="col-lg-6 welcome-left pr-lg-5">
							...
							<h7>Nuestro principal objetivo es ofrecerle un servicio eficiente utilizando la más alta tecnología y los productos de mayor calidad en pro de ofrecer una satisfacción total a sus clientes.</h7>

							<h3 class="mt-2 mb-3">Misión</h3>

							<h7>Ofrecer un servicio de excelencia a nuestros clientes, basado en la asesoría profesional y personalizada, y ofreciendo soluciones a la salud e imagen del cliente.</h7>

							<h3 class="mt-2 mb-3">Visión</h3>

							<h7>Cuidar y resolver las necesidades ópticas de nuestros clientes al través de nuestros muchos años de experiencia profesional.</h7>

							<h2 class="mt-2 mb-3">Valores</h2>

							<h3 class="mt-2 mb-3">Compromiso con las personas:</h3><h7> identificando sus necesidades, buscando en todo momento la profesionalidad máxima, implicación y exigencia en nuestras actuaciones. Haciendo de nuestras acciones preventivas, divulgativas y docentes, curativas y, también, paliativas un ejercicio profesional digno, integrado e integral al paciente y a su entorno más cercano.</h7><br><br>

<h3 class="mt-2 mb-3">Compromiso con nuestros profesionales:</h3><h7> velando por la equidad de oportunidades y la no discriminación, el respeto individual, el respecte individual y colectivo, el desarrollo de las capacidades, reforzando tanto su consideración individual, como el trabajo en equipo con un elevado nivel de exigencia e implicación.</h7><br><br>

<h3 class="mt-2 mb-3">Calidad:</h3><h7> con la divisa de la excelencia. RIGOR CIENTÍFICO Y TÉCNICO y esfuerzo para lograr un alto grado de eficiencia en todas nuestras acciones. Calidad humana, científica y técnica al servicio de nuestros pacientes, sus familias y, en los casos que corresponda, al servicio de las compañías aseguradoras que velan por su salud.</h7><br><br>

<h3 class="mt-2 mb-3">Trato y respeto:</h3><h7> Empatía, Inmediatez, Proximidad, Sensibilidad y Animosidad, aspectos imprescindibles per conseguir la confianza plena del nuestros pacientes.</h7><br><br>

<h3 class="mt-2 mb-3">Flexibilidad:</h3><h7> las necesidades de nuestros clientes son cambiantes en el tiempo, así como sus expectativas. Nuestro objetivo es ser, en todo momento, cercanos, proactivos, efectivos y resolutivos, buscando en todo momento, formas diferentes de atención y servicios, adaptándonos en todo momento.</h7><br><br>

<h3 class="mt-2 mb-3">Sustentabilidad:</h3><h7> tanto económica (eficiencia) como del entorno (responsabilidad social corporativa). La viabilidad y continuidad de nuestro propósito sólo es posible si velamos en todo momento por la eficiencia en la gestión de los recursos. Dejar un mundo mejor que pueda verse mejor (que pueda ser admirado), tanto a las generaciones presentes como futuras, es parte indisoluble de nuestra forma de ser, de ver y de hacer.</h7><br><br>
